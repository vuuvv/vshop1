...
var settings = {"qx.application":"vuuvv.Application","qx.revision":"unknown","qx.theme":"vuuvv.theme.Theme","qx.version":"1.4"};
...
var envinfo = {"qx.application":"vuuvv.Application","qx.debug":false,"qx.revision":"unknown","qx.theme":"vuuvv.theme.Theme","qx.version":"1.4"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"qx":{"resourceUri":"resource","sourceUri":"script","version":"1.4"},"vuuvv":{"resourceUri":"resource","sourceUri":"script","version":"trunk"}};
...
(function(){var d="vuuvv/test.png",c="vuuvv.Application",b="First Button",a="execute";
...
qx.Mixin.define(j,{events:{"execute":g},properties:{command:{check:b,apply:f,event:a,nullable:true}},members:{__ls:null,__lt:false,__lu:null,_bindableProperties:[d,k,l,m,h,c],execute:function(){var o=this.getCommand();

if(o){if(this.__lt){this.__lt=false;
}else{this.__lt=true;
o.execute(this);
}}this.fireEvent(n);
},__lv:function(e){if(this.__lt){this.__lt=false;
return;
}this.__lt=true;
this.execute();
},_applyCommand:function(p,q){if(q!=null){q.removeListenerById(this.__lu);
}
if(p!=null){this.__lu=p.addListener(n,this.__lv,this);
}var t=this.__ls;

if(t==null){this.__ls=t={};
}var u;
...
}},members:{__lw:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__lw;
},getMarkup:function(e){if(this.__lw){return this.__lw;
...
qx.Mixin.define(o,{include:[qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBackgroundImage],construct:function(){this._getDefaultInsetsForBorder=this.__lB;
this._resizeBorder=this.__lA;
this._styleBorder=this.__ly;
this._generateMarkup=this.__lz;
},properties:{innerWidthTop:{check:f,init:0},innerWidthRight:{check:f,init:0},innerWidthBottom:{check:f,init:0},innerWidthLeft:{check:f,init:0},innerWidth:{group:[w,z,n,k],mode:a},innerColorTop:{nullable:true,check:g},innerColorRight:{nullable:true,check:g},innerColorBottom:{nullable:true,check:g},innerColorLeft:{nullable:true,check:g},innerColor:{group:[u,v,x,r],mode:a}},members:{__lx:null,__ly:function(D){var E=qx.theme.manager.Color.getInstance();
D.position=t;
...
}},__lz:function(G){var J=this._generateBackgroundMarkup(G);
...
G[y]=0;
G[p]=0;
return this.__lx=this._generateBackgroundMarkup(G,J);
},__lA:function(K,L,M){var N=this.getInsets();
L-=N.left+N.right;
M-=N.top+N.bottom;
...
},__lB:function(){return {top:this.getWidthTop()+this.getInnerWidthTop(),right:this.getWidthRight()+this.getInnerWidthRight(),bottom:this.getWidthBottom()+this.getInnerWidthBottom(),left:this.getWidthLeft()+this.getInnerWidthLeft()};
}}});
})();
...
}},properties:{innerColor:{check:d,nullable:true,apply:i},innerOpacity:{check:o,init:1,apply:i},outerColor:{check:d,nullable:true,apply:i}},members:{__lC:null,_getDefaultInsets:function(){return {top:2,right:2,bottom:2,left:2};
},_isInitialized:function(){return !!this.__lC;
},_applyStyle:function(){},getMarkup:function(){if(this.__lC){return this.__lC;
...
if(qx.ui.decoration.css3.BorderImage.IS_SUPPORTED){this.__lD=new qx.ui.decoration.css3.BorderImage();

if(n){this.__lE(n);
}}else{this.__lD=new qx.ui.decoration.GridDiv(n);
}
if(o!=null){this.__lD.setInsets(o);
}},properties:{baseImage:{check:c,nullable:true,apply:h},insetLeft:{check:m,nullable:true,apply:l},insetRight:{check:m,nullable:true,apply:l},insetBottom:{check:m,nullable:true,apply:l},insetTop:{check:m,nullable:true,apply:l},insets:{group:[i,j,g,a],mode:e}},members:{__lD:null,getMarkup:function(){return this.__lD.getMarkup();
},resize:function(p,q,r){this.__lD.resize(p,q,r);
},tint:function(s,t){},getInsets:function(){return this.__lD.getInsets();
},_applyInsets:function(u,v,name){var w=f+qx.lang.String.firstUp(name);
this.__lD[w](u);
},_applyBaseImage:function(x,y){if(this.__lD instanceof qx.ui.decoration.GridDiv){this.__lD.setBaseImage(x);
}else{this.__lE(x);
}},__lE:function(z){var B,D;
this.__lD.setBorderImage(z);
...
}},statics:{IS_SUPPORTED:qx.bom.element.Style.isPropertySupported("borderImage")},properties:{borderImage:{check:t,nullable:true,apply:j},sliceTop:{check:h,init:0,apply:j},sliceRight:{check:h,init:0,apply:j},sliceBottom:{check:h,init:0,apply:j},sliceLeft:{check:h,init:0,apply:j},slice:{group:[n,v,a,w],mode:c},repeatX:{check:[i,e,d],init:i,apply:j},repeatY:{check:[i,e,d],init:i,apply:j},repeat:{group:[u,m],mode:c}},members:{__lF:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__lF;
...
this.__lF=[x,qx.bom.element.Style.compile({"borderImage":o+B+p+C.join(f)+f+D,position:k,lineHeight:0,fontSize:0,overflow:l,boxSizing:r,borderWidth:C.join(b)+g}),y].join(q);
return this.__lF;
...
}},properties:{baseImage:{check:q,nullable:true,apply:s}},members:{__lG:null,__lH:null,__lI:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__lG;
...
F.push(a);
return this.__lG=F.join(o);
},resize:function(G,H,I){var J=this.__lI;
...
var Q=S[1];
var P=S[2];
var O=this.__lH={tl:Q+v+P,t:Q+x+P,tr:Q+c+P,bl:Q+p+P,b:Q+r+P,br:Q+y+P,l:Q+b+P,c:Q+n+P,r:Q+u+P};
this.__lI=this._computeEdgeSizes(O);
